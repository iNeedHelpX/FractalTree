...
class colorTreeView: UIView{
    ...
    override func draw(_ rect: CGRect) {
        ...
        let colors = [colorOne.cgColor, colorTwo.cgColor] as CFArray
       ...
       drawBranch(x1: self.frame.width / 2, y1: self.frame.height * 0.9, angle: -90, depth: self.treeDepth)
...
let view = colorTreeView(frame: CGRect(x: 0, y: 0, width: 400, height: 400))
